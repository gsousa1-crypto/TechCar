...
class VeiculoApiControllerTest {
    ...
    void testListarTodos() throws Exception {
        mockMvc.perform(get("/api/veiculos"))
                ...
                // ✅ 2. CORREÇÃO:
                // Verifica se o JSON (representado por '$') é uma array
                // com tamanho (size) maior que (greaterThan) 0.
                .andExpect(jsonPath("$", hasSize(greaterThan(0))))

                // Verifica se na lista de 'marca' ($.*.marca),
                // existe (hasItem) o valor "Toyota".
